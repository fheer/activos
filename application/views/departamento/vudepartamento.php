...
<div class="col-md-10">
	<div class="content-box-large">
		...
		<div class="panel-body">
			<div class="row">
				<div class="col-md-6">
					<?php echo form_open_multipart(base_url() . 'departamento/CDepartamento/edit', array("class" => "form-horizontal")); ?>
					<div class="form-group">
						<label for="cargo" class="col-md-4 control-label"><span class="text-danger">*</span>
							Cargo</label>
						<div class="col-md-4">
							<input type="hidden" class="form-control input-sm" name="idDepartamento" id="idDepartamento"
								   value="<?php echo $departamento['idDepartamento']; ?>"/>
							<input type="text" class="form-control input-sm" name="departamento" id="departamento"
								   value="<?php echo $departamento['departamento']; ?>"/>
							<span class="text-danger"><?php echo form_error('departamento'); ?></span>
						</div>
					</div>

					<div class="box-footer">
						<a href="<?php echo base_url(); ?>departamento/CDepartamento/"
